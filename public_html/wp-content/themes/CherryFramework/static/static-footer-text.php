...
<div id="footer-text" class="footer-text">
	...
	<?php if( is_front_page() ) { ?>
		More <a rel="nofollow" href="http://www.templatemonster.com/category/university-wordpress-themes/" target="_blank">University WordPress Themes at TemplateMonster.com</a>
	<?php } ?>
</div>