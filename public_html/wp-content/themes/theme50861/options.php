...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#cccccc'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '48px', 'lineheight' => '54px', 'face' => 'Roboto Condensed', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333333'));
			...
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '18px', 'face' => 'Roboto Condensed', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto Condensed', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Roboto Condensed', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '48px', 'lineheight' => '48px', 'face' => 'Roboto Condensed', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#696969'));
		return $options;
	}
}
?>